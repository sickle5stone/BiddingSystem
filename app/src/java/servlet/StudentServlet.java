...
public class StudentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String updateBid = request.getParameter("updateBid");
        ...
        if (searchCourse!=null && searchCourse.equals("yes")){
            ...
            double newAmount = Double.parseDouble(request.getParameter("newAmt"));
            if (courseCode != null && sectionCode != null && userId != null && newAmount > 0.0){
            BidController.updateBid(userId, newAmount, sectionCode, courseCode);
