...
public class dropSectionServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet dropSectionServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet dropSectionServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String dropSection= request.getParameter("dropSection");
        if(dropSection!=null && dropSection.equals("confirmDrop")){
            ...
            if (SectionStudentController.deleteSectionFromStudent(userId, courseCode, sectionCode)){
                response.sendRedirect("studenthome.jsp");
            }
            else {
                RequestDispatcher view = request.getRequestDispatcher("message.jsp");
                request.setAttribute("msg", "Failed to delete section.");
